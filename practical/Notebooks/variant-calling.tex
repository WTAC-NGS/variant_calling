...
characters. The caret symbol \^{} marks the start of a read (followed by
the mapping quality encoded as an ASCII character), the dollar sign \$
the end of a read, deleted bases are represented by asterisk *.
